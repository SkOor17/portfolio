        ...
        <div>
          ...
          <div className="inline-flex">
            ...
            <p className="title !text-custom-xl">
              <TextUnderline size="xl" className="left-4 top-12">portfolio</TextUnderline>
            </p>
          </div>
        </div>
        <div className="w-3/4 flex justify-center lg:w-fit">
          <img className="h-full lg:max-h-[calc(60vh)] max-w-[calc(40vh)] rounded-lg" src="/assets/heroImg.jpg" alt="" />
        </div>
      </div>
      <div className="max-w-[calc(40vh)] w-full lg:max-w-none lg:w-3/4 pb-6 flex justify-end">
